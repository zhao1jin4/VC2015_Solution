...
ControlWizard has created this project for your MFCActiveX ActiveX Control
...
that make up your MFCActiveX ActiveX Control DLL.
...
MFCActiveX.ico
    ...
    is included by the main resource file MFCActiveX.rc.

/////////////////////////////////////////////////////////////////////////////
CMFCActiveXCtrl control:

MFCActiveXCtrl.h
    This file contains the declaration of the CMFCActiveXCtrl C++ class.

MFCActiveXCtrl.cpp
    This file contains the implementation of the CMFCActiveXCtrl C++ class.

MFCActiveXPropPage.h
    This file contains the declaration of the CMFCActiveXPropPage C++ class.

MFCActiveXPropPage.cpp
    This file contains the implementation of the CMFCActiveXPropPage C++ class.

CMFCActiveXCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CMFCActiveXCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file MFCActiveX.rc.
...
stdafx.h, stdafx.cpp
    ...
    named MFCActiveX.pch and a precompiled types (PCT) file named stdafx.obj.
